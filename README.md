# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Sellers
...
```shell
composer require bricre/amazon-selling-partner-sdk-sellers
```
